...
/**
	...
	/**
		...
		public void waitForPage(WebDriver driver , String partailPageURL) {
			WebDriverWait wait = new WebDriverWait(driver, Explicitlty_TIMEOUT);
		 ...
		 * @param driver 
		 */
		public void swithToAlertWindowAndAccpectOnly(WebDriver driver) {
			Alert alt = driver.switchTo().alert();
...
/**It is used to selectby value from the Dropdown
 * @author Pavithra
 */

public void selectByValue(WebElement ele,String Lastname)
{
